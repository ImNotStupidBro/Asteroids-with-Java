...
public class Score{
   ...
   public Score(int smallAsteroidsHit, int largeAsteroidsHit, int alienShipsHit){
   ...
   public void addScore(int smallAsteroids, int largeAsteroids, int alienShips){
      totalPoints += (smallAsteroids*smallMultiplier) + (largeAsteroids*largeMultiplier)+(alienShips*alienMultiplier);
   }
